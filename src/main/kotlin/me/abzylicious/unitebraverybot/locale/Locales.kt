...
object Messages {
    ...
    const val SETUP_RANDOMIZE_LANE = "Set Lane randomization. This can later be changed via the **/configuration lanerandomization** command."
    const val SETUP_RANDOMIZE_HELD_ITEMS = "Set Held Items randomization. This can later be changed via the **/configuration helditemsrandomization** command."
    const val SETUP_RANDOMIZE_BATTLE_ITEMS = "Set Battle Item randomization. This can later be changed via the **/configuration battleitemrandomization** command."
...
object CommandDescriptions {
    ...
    const val CONFIGURATION_LANE_RANDOMIZATION = "Set Lane randomization"
    const val CONFIGURATION_HELD_ITEMS_RANDOMIZATION = "Set Held Items randomization"
    const val CONFIGURATION_BATTLE_ITEM_RANDOMIZATION = "Set Battle Item randomization"
